        ...
        >
          ...
          <div className="flex flex-col items-center gap-8 text-2xl font-bold tracking-widest uppercase w-full px-6 text-center" style={{ position: 'relative', zIndex: 10 }}>
            {[
              ...
              <motion.div custom={i} variants={linkVariants} initial="closed" animate="open" key={link.name}>
                <Link 
                  href={link.href} 
                  onClick={toggleMenu}
            ...
            <motion.div custom={4} variants={linkVariants} initial="closed" animate="open" className="mt-4">
               <Link 
                 href="/#contact" 
                 onClick={toggleMenu}
